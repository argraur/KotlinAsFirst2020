...
fun russian(n: Int): String {
    var s = StringBuilder()
    var tenth = false
    n.toString().forEachIndexed { index, i ->
        when (val pos = n.length() - index) {
            6, 3 -> {
                s.append(
                    when (i) {
                        '1' -> "сто "
            ...
            5, 2 -> {
                when (i) {
                    ...
                    '3' -> s.append("тридцать ")
                    '4' -> s.append("сорок ")
                    '5' -> s.append("пятьдесят ")
                    '6' -> s.append("шестьдесят ")
                    '7' -> s.append("семьдесят ")
                    '8' -> s.append("восемьдесят ")
                    '9' -> s.append("девяносто ")
                }
            }
            4, 1 -> {
                if (tenth) {
    ...
    return s.removeSuffix(" ").toString()
}